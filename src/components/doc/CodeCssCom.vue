...
<template>
    ...
    <button @click="code ? (console.log(CodeCssCom.zip(code))) : tips(1)" class="child mdui-btn mdui-btn-dense mdui-color-theme-accent mdui-btn-raised mdui-ripple">压缩</button>
