...
<template>
    ...
    <button @click="code ? (code = CodeCssCom.zip(code)) : tips(1)" class="child mdui-btn mdui-btn-dense mdui-color-theme-accent mdui-btn-raised mdui-ripple" mdui-tooltip="{content: '将代码压缩成一行'}">压缩</button>
